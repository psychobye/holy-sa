...
public:
    bool  Process(CVehicleMP* vehicle, CVector& arg1, CVector& arg2, Const CVector& arg3);
    bool  ProcessImpact(CVehicleMP* vehicle, CVector& arg1, CVector& arg2, Const CVector& arg3);

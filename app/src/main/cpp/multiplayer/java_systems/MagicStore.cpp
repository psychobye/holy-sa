...
Java_com_holy_game_gui_magicStore_MagicStore_nativeOnClose(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_holy_game_gui_magicStore_MagicStore_nativeSendClick(JNIEnv *env, jobject thiz, jint click_type, jint index, jint category) {
    RakNet::BitStream bs;

...
Java_com_holy_game_gui_inventory_Inventory_sendSelectItem(JNIEnv *env, jobject thiz, jint matrixId,
                                                    jint pos) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_holy_game_gui_inventory_Inventory_sendClickButton(JNIEnv *env, jobject thiz, jint buttonid) {
    RakNet::BitStream bs;
    bs.Write((uint8_t)  ID_CUSTOM_RPC);
    bs.Write((uint8_t)  RPC_INVENTORY);

...
Java_com_holy_game_gui_Registration_nativeChooseSkinClick(JNIEnv *env, jobject thiz, jint choosesex) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_holy_game_gui_Registration_nativeSkinBackClick(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_holy_game_gui_Registration_nativeSkinNextClick(JNIEnv *env, jobject thiz) {
    g_pJavaWrapper->RegisterSkinValue++;
    if (g_pJavaWrapper->RegisterSexMale == 1) // man
    {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_holy_game_gui_Registration_nativeClick(JNIEnv *pEnv, jobject thiz, jstring password, jstring mail, jint sex) {

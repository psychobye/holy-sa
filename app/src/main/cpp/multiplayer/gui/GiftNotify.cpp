...
Java_com_holy_game_gui_GiftNotify_nativeHide(JNIEnv *env, jobject thiz) {
    env->DeleteGlobalRef(CGiftNotify::thiz);
    CGiftNotify::thiz = nullptr;
}
extern "C"
JNIEXPORT void JNICALL
Java_com_holy_game_gui_treasure_Treasure_nativeShowGiftNotify(JNIEnv *env, jobject thiz,

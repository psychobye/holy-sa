...
class SettingsFragment : Fragment() {
    ...
    private fun onClickInit() {
        ...
        logBtn?.setOnClickListener {
            val logFile = File(Config.GAME_PATH, Config.LOG_FILE_PATH)
            val crashLogFile = File(Config.GAME_PATH, Config.CRASH_LOG_FILE_PATH)
            ...
            val emailIntent = Intent(Intent.ACTION_SEND_MULTIPLE).apply {
                type = "message/rfc822"
                putExtra(Intent.EXTRA_EMAIL, arrayOf(Config.SUPPORT_MAIL))

package com.lit.launcher.download

import com.lit.launcher.NetworkService
import com.lit.launcher.async.dto.response.FileInfo
import com.lit.launcher.config.Config.APK_FILE_NAME
import com.lit.launcher.config.Config.ZIP_FILES_BASE_ADR
import com.lit.launcher.ui.activity.LoaderActivity
import com.lit.launcher.utils.BytesTo
